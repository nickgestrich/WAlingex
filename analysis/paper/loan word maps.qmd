...
This graph is somewhat perplexing. What does the connection between Bangime (wīī-bɛ̀) and Igo (ā-wúbī,volta-Congo langue in southern Togo) mean? This is a question that needs further answering. 
For now, we can remove this pair, and concentrate on the rest.
...
Here are several analytical strategies, ranging from classical network analysis to spatially informed metrics:
🧭 1. Weighted Shortest Paths (Trade Efficiency)
